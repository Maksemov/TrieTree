...
Type
  ...
  TNode = class
    ...
    public
      ...
      procedure resString (s: string; var ResCount :integer; chr: char);
...
procedure TNode.resString (s:string;var ResCount: integer; chr: char);
var
  k, i: integer;
  ch: TIndex;
  ok: boolean;
begin
  ...
  for ch := Low(TIndex) to High(TIndex) do
    if Ptrs[ch] <> nil then
      Ptrs[ch].resString(s+ch, ResCount, chr)
end;
